...
Some of this application main features are:
...
2. Clone the repo
   ```sh
   git clone git@github.com:< USERNAME >/Project_TrybeTunes.git
   ```
...
4. Start the server
   ...
   npm start
   ```
5. To log into the application use a random valid email and a password longer than 6 characters
...
Project Link: [https://github.com/RenatoDourad0/Project_TrybeTunes](https://github.com/RenatoDourad0/Project_TrybeTunes)
